...
public class _LocalServerStub extends org.omg.CORBA.portable.ObjectImpl implements Carpark.LocalServer
{
  ...
  public void ticket_created (Carpark.Ticket ticket)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("ticket_created", true);
                Carpark.TicketHelper.write ($out, ticket);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
