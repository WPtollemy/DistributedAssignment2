...
abstract public class TicketHelper
{
  ...
  public static Carpark.Ticket read (org.omg.CORBA.portable.InputStream istream)
  {
    ...
    value.startDate = Carpark.DateTimeHelper.read (istream);
    value.stay_length = istream.read_long ();
  ...
  {
    Carpark.DateTimeHelper.write (ostream, value.startDate);
    ostream.write_long (value.stay_length);
